...
def main():
    ...
    print("\n--- 2D Airfoil Results ---")
    print(f"Average pressure:             {p_air_2d:.4f} Pa")  
    print(f"Average temperature:          {T_air_2d:.2f} K")  
    print(f"Air density (rho):            {rho_air_2d:.4f} kg/m³")
    print(f"Reference dynamic pressure:   {q_inf_2d:.4f} Pa")
    print(f"Reference static pressure:    {ref_static_p_inf_2d:.4f} Pa")
    ...
    print("\n--- 3D Wing Results ---")
    print(f"Average pressure:             {p_air_3d:.4f} Pa")  
    print(f"Average temperature:          {T_air_3d:.2f} K")  
    print(f"Air density (rho):            {rho_air_3d:.4f} kg/m³")
    print(f"Reference dynamic pressure:   {q_inf_3d:.4f} Pa")
    print(f"Reference static pressure:    {ref_static_p_inf_3d:.4f} Pa")
